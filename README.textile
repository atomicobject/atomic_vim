...
In your @~/.vimrc@, add @source ~/.vim/common-vimrc.vim@ and @brew install ctags@ to get exuberant ctags. I've mainly used the config under cygwin on windows, but gvim works pretty well (I've never tried setting up ctags and ruby on windows without cygwin).
